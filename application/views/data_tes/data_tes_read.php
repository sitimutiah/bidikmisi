                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title" id="2">Form Tambah Testing</h4>
                                                </div>

                                            <form action="<?php echo base_url('desa/tambah_dusun')?>" method="POST">
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        <label for="varchar">Gaji Orang Tua</label>
                                                        <input required type="text" class="form-control" name="gaji_ortu" id="dusun" placeholder="gaji_ortu"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="varchar">Tanggungan Ortu</label>
                                                        <input required type="text" class="form-control" name="tanggungan_ortu" id="tanggungan_ortu"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="varchar">IPK</label>
                                                        <input required type="text" class="form-control" name="ipk_mhs" id="ipk_mhs"/>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="varchar">Menerima Beasiswa Lain</label>
